...
for(n in db.conferences)if(n===e.toLowerCase().trim())return o=db.conferences[n],cal=ics(),cal.addEvent(o.title,o.full_title,o.location,o.submission,o.submission),cal.download(),!1}function arrayObjectIndexOf(e,n,o){for(var t=0,r=e.length;r>t;t++)if(void 0!=e[t]&&e[t][o]===n)return t
